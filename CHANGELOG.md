...
* entrypoint: Update yq eval expression to v4 [Kyle Harding]
* workflows: Remove deploy to DockerHub action [Kyle Harding]
* Combine dockerfiles and pin npm module versions [Kyle Harding]
